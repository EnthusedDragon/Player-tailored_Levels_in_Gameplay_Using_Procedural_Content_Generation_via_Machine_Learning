...
public class HuntAndKillMazeAlgorithm : MazeAlgorithm {
    ...
    private string seed = "123424123342421432233144441212334432121223344";
    private int currentSeedPosition = 0;

    public HuntAndKillMazeAlgorithm(MazeCell[,] mazeCells, string newSeed) : base(mazeCells) {
        seed = newSeed;
	}
    ...
    {
        string currentNum = seed.Substring(currentSeedPosition++ % seed.Length, 1);
